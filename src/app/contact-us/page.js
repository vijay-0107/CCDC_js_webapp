                    ...
                    <div className="grid-80">
                        <div className="grid-block">
                            <div className="index-intro-text">
                                <h1>Contact Us</h1>
                                <p>
                                    Training and placement cell (TPC) of the
                                ...
                                <p>
                                    Interested companies can directly contact
                                    through email:{" "}
                                    <span
                                        style={{
                                            color: "#0000FF",
                                    ...
                                    +91-6115-233 091/083 and +91-8102917501
                                </p>
                                <h2>
                                    <u>Professor In-charge</u>
                                </h2>
                                <div className="grid-container">
                                    <div className="grid-item">
                                        ...
                                        <div className="facinfo">
                                            <b>Dr. Ashwani Assam</b>
                                            <br />
                                            Phone No.: +91-6115-233829
                                            <br />
                                            Email: pic_tnp@iitp.ac.in,
                                            tpc@iitp.ac.in
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid-container">
                                    <div className="grid-item">
                                        ...
                                        />
                                        <div className="facinfo">
                                            <b>Mr. Kripa Shankar Singh</b>
                                            <br />
                                            Training and placement Officer (TPO)
                                            <br />
                                            Phone No: +91-6115-233091
                                            <br />
                                            Mobile : +91-8102917501
                                            <br />
                                            Email : kripa@iitp.ac.in |
                                            tpc@iitp.ac.in
                                        </div>
                                    </div>
                                    <div className="grid-item">
                                        ...
                                        />
                                        <div className="facinfo">
                                            <b>Mr. Amit Kumar Singh</b>
                                            <br />
                                            Jr. Assistant
                                            <br />
                                            Phone no : +91-6115-233083
                                            <br />
                                ...
                                <p>
                                    ...
                                    <br />
                                    Bihta Kanpa Road, Bihta,
                                    <br />
                                    Bihar Pin - 801106, India.
                                    <br />
                                </p>
                                <hr />
                            </div>
