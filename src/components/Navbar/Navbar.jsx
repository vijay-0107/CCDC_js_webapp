        ...
        <div className="header navbar">
            <a href="http://www.iitp.ac.in/placement/">
                <div className="college-logo">
                    ...
                    <div className="college-text" style={{ paddingLeft: '22px' }}>
                        <span style={{ fontSize: '18pt' }}>Training and Placement Cell</span><br /><span
                            style={{ fontSize: '22pt' }}>प्रशिक्षण एवं स्थानन प्रकोष्ठ</span><br /><br />
                        <h3>Indian Institute of Technology Patna<br /><span style={{ fontSize: '18pt' }}>भारतीय प्रौद्योगिकी
                            संस्थान पटना</span></h3>
                    </div>
                </div>
            </a>
            <div className="navbar-collapse scrollspy smooth-scroll collapse" id="nav">
                <ul>
                    <li><a href="index.php">About Us</a>
                        <ul>
                            <li><a href="index.php">TPC Cell</a></li>
